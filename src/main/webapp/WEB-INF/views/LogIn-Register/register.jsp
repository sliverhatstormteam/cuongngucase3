            ...
            <div class="card-body p-5">
              ...
              <form action="/register" method="post">
                <div class="form-outline mb-2">
                  ...
                  <input type="text" name="email" class="form-control form-control-lg" pattern="\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+" required>

                </div>
                <div class="form-outline mb-2">
                  <div class="col-6" id="div_left" style="padding-left: 0px">
                    <label class="form-label" >Password</label>
                    <input type="password" id="password" name="password" class="form-control form-control-lg" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" title="Please include at least 1 uppercase character, 1 lowercase character, and 1 number." required>

                  </div>
                  <div class="col-6" id="div_right" style="padding-right: 0px">
                    <label class="form-label">Repeat your password</label>
                    <input type="password" id="confirm_password" name="repeatyourpassword" class="form-control form-control-lg" required/>
                ...
                <div class="form-outline mb-2">
                  ...
                  <input type="text" name="phone" class="form-control form-control-lg" pattern="\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})" required />
                </div>
                <div class="form-outline mb-2">
                  <label class="form-label">Your Img</label>
                  <input type="text" name="img" class="form-control form-control-lg" required />
                </div>
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account?
                  <a href="/login" class="fw-bold text-body"><u>Login here</u>
                  </a>
                </p>
              </form>
            </div>
